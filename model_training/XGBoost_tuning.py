"""
The best hyper-parameters selected from hyper_parameters_grid_search.py are used to train the model. 
"""
##################################################
...
if __name__ == "__main__":
    ...
    with mlflow.start_run():
        # Instantiating model with model parameters: Choosing learning_rate=0.1, max_depth=2
        model = xgb.XGBClassifier(base_score=0.5, booster='gbtree', callbacks=None,
              ...
              num_parallel_tree=1, predictor='auto', random_state=seed,
        ...
        model_name = 'xgboost_after_tuning'
        ...
        model_file_name = "XGBoost_after_tuning.pkl"
